...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/logo-ct-new.png">
  <title>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="../assets/img/logo-ct-new.png" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Datasets</span>
          </a>
        </li>
        <!-- <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/profile.html">
            ...
            <span class="nav-link-text ms-1">Director Profile</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/sign-in.html">
            ...
            <span class="nav-link-text ms-1">Reviewer's Profile</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../pages/sign-up.html">
            ...
            <span class="nav-link-text ms-1">Scholar's Profile</span>
          </a>
        </li>
      </ul>
    </div>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <!-- <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="#/builder?ref=navbar-soft-ui-dashboard">Online Builder</a>
            </li> -->
            <li class="nav-item d-flex align-items-center">
