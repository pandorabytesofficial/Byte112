...
?>
<script>var exportFilename = 'Admins';</script>
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr class='text-gray-700 dark:text-gray-100'>
                                ...
                                <th class='border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left'><a href='viewAdminData.php?id=".$id_paper."'>" . $row['name'] . "</a></th>
                                ...
                                <td class='border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4'>
                                    ...
                                    <a href='delAdmin.php?id=" . $id_paper . "'>
